...
# DO NOT EDIT! This is a generated sample ("Request",  "translate_get_glossary_beta")
...
#   usage: python3 samples/v3beta1/translate_get_glossary_beta.py [--project "[Google Cloud Project ID]"] [--glossary_id "[Glossary ID]"]

# [START translate_get_glossary_beta]
from google.cloud import translate_v3beta1


def sample_get_glossary(project, glossary_id):
    """Get Glossary"""
...
def main():
    ...
    sample_get_glossary(args.project, args.glossary_id)
